...
router2.all("*", () => {
  return Corsify_default(new Response("Not Found", { status: 404 }));
});
...
router3.all("/v1/waitlist/:rest*", handleWaitlist);
...
// .wrangler/tmp/bundle-bjPu0m/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bjPu0m/middleware-loader.entry.ts
