...
async function getAccessToken() {
  ...
  }).setProtectedHeader({ alg: "RS256", typ: "JWT" }).setAudience(creds.token_uri).setIssuer(client_email).setIssuedAt(now).setExpirationTime(now + 3600).sign(privateKey);
...
async function addToEmails(req, email) {
  ...
  const spreadsheet_id = env2.GOOGLE_SPREADSHEET_ID;
  try {
...
// .wrangler/tmp/bundle-Kb84rI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Kb84rI/middleware-loader.entry.ts
