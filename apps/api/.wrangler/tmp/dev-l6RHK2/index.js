...
router.get("/test", () => {
  ...
  return Corsify_default(new Response(JSON.stringify(data), { status: 200 }));
});
...
// .wrangler/tmp/bundle-167jmr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-167jmr/middleware-loader.entry.ts
