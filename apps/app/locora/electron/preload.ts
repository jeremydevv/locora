...
contextBridge.exposeInMainWorld("authAPI", {
    ...
    getExpiresIn : () => ipcRenderer.invoke("get-expires-in"),
    ...
    refreshSessionData : () => ipcRenderer.invoke("refresh-session-data") as Promise<DataPayload>,
